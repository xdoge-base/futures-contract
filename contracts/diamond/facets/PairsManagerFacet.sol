...
contract PairsManagerFacet is IPairsManager {
    ...
    function addPair(
        ...
        LibPairsManager.updatePairFundingFeeConfig(
            base, pairConfig.fundingFeePerSecondP, pairConfig.minFundingFeeR, pairConfig.maxFundingFeeR
        );
    }
    ...
    function updatePairFundingFeeConfig(
        ...
        LibAccessControlEnumerable.checkRole(Constants.PAIR_OPERATOR_ROLE);
        require(base != address(0), "PairsManagerFacet: Base cannot be 0 address");
        LibPairsManager.updatePairFundingFeeConfig(base, fundingFeePerSecondP, minFundingFeeR, maxFundingFeeR);
    }
    ...
    function _pairToView(
        ...
        IPairsManager.PairView memory pv = IPairsManager.PairView(
            ...
            pair.fundingFeePerSecondP, pair.minFundingFeeR, pair.maxFundingFeeR, leverageMargins,
    ...
    function getPairForTrading(address base) external view override returns (TradingPair memory) {
        ...
        return TradingPair(
            ...
            PairMaxOiAndFundingFeeConfig(pair.maxLongOiUsd, pair.maxShortOiUsd, pair.fundingFeePerSecondP, pair.minFundingFeeR, pair.maxFundingFeeR),
            lms,
    ...
    function getPairConfig(address base) external view override returns (PairMaxOiAndFundingFeeConfig memory) {
        ...
        return PairMaxOiAndFundingFeeConfig(pair.maxLongOiUsd, pair.maxShortOiUsd, pair.fundingFeePerSecondP, pair.minFundingFeeR, pair.maxFundingFeeR);
    }
